...
class CallerDom extends EventEmitter {
  ...
  _callFunc(tFunc, params = {}, priority = false, forceTimeout = false) {
    let caller = new TamedFuncCaller(
