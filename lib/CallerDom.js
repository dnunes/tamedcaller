...
class CallerDom extends EventEmitter {
  ...
  _runNextCall() {
    ...
    if (this._intervalAfterReturn) { //scheduled
      promise.then(() => {
  ...
  pollExternal(name, interval, tFunction, params = ['nodeback']) {
